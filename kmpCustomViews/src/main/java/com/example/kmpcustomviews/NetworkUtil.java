...
public class NetworkUtil {
    ...
    public static void setNetworkChangeReceiver(NetworkChangeReceiver networkChangeReceiver) {
        NetworkUtil.networkChangeReceiver = networkChangeReceiver;
    }

    public static void registerForInternetConnection(NetworkConnectionListner networkConnectionListner, Context context){
         networkChangeReceiver = new NetworkChangeReceiver(networkConnectionListner);
         setNetworkChangeReceiver(networkChangeReceiver);
        context.registerReceiver(networkChangeReceiver,new IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION));
    }

    public static void unRegisterForInternetConnection(Context context){
