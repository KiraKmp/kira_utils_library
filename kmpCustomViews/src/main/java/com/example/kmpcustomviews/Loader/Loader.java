package com.example.kmpcustomviews.Loader;
...
import com.example.kmpcustomviews.R;
...
public class Loader extends AlertDialog {
   ...
   static AlertDialog dialog;
    ...
    public AlertDialog getBuilder(Context context,String message){
        getInstance(context);
        dialog= new Loader.Builder()
                .setContext(context)
                .setMessage(message)
                .build();
       return dialog;
    ...
    {
        getInstance(context).getBuilder(context,message).show();
    }
    ...
    protected Loader(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
    }

    protected Loader(Context context, int themeResId) {
    ...
    private Loader(Context context, String message, int theme, boolean cancelable, OnCancelListener cancelListener) {
        super(context, theme);
        this.message = message;
